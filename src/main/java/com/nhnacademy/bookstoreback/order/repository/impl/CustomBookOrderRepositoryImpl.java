            ...
            .collect(Collectors.groupingBy(
                ...
                Collectors.collectingAndThen(
                    ...
                    list -> {
                        ...
                        BigDecimal salePrice = list.getFirst().get(book.bookSalePrice); // Assuming sale price is the same for all tuples
                        return new GetBookByOrderCouponResponse(list.getFirst().get(bookOrder.book.bookId), salePrice, categoryIds);
                    }
                )
            ));
